...
function joyas_storefront_footer_info (){
        $text ='';
        $html = '<div class="container site_info">
            ...
            }else
            {
                ...
                $text .= sprintf( esc_html__( 'Copyright &copy; %1$s %2$s. All Right Reserved.', 'joyas-storefront' ), date_i18n( _x( 'Y', 'copyright date format', 'joyas-storefront' ) ), esc_html( get_bloginfo( 'name' ) ) );
            ...
            $html  .= '<span class="dev_info">'.sprintf( esc_html__( ' %1$s theme by aThemeArt - Proudly powered by %2$s .', 'joyas-storefront' ), '<a href="'. esc_url( 'https://athemeart.com/' ) .'" target="_blank">'.esc_html_x( 'Joyas Storefront', 'credit - theme', 'joyas-storefront' ).'</a>',  '<a  href="'.esc_url( __( 'https://wordpress.org', 'joyas-storefront' ) ).'" target="_blank" rel="nofollow">'.esc_html_x( 'WordPress', 'credit to cms', 'joyas-storefront' ).'</a>' ).'</span>';
     ...
     add_action('joyas_shop_site_footer', 'joyas_storefront_footer_info', 30 );
